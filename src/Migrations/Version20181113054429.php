 ...
 */
final class Version20181113054429 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE marketing CHANGE discount_price discount DOUBLE PRECISION NOT NULL, CHANGE validity_datet validity_date INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE marketing CHANGE discount discount_price DOUBLE PRECISION NOT NULL, CHANGE validity_date validity_datet INT NOT NULL');
